...
/*
 * 所需库：Adafruit_NeoPixel点击这里会自动打开管理库页面: http://librarymanager/All#Adafruit_NeoPixel
 */
#include <Adafruit_NeoPixel.h>//点击这里会自动打开管理库页面: http://librarymanager/All#Adafruit_NeoPixel
#ifdef __AVR__
...
//  亮度设置, 0 (min) to 255 (max)，注意在Proteus仿真时，尽量将其值设置为最大，不然显示效果很暗！
